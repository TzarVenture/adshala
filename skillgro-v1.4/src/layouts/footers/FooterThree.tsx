...
import shape from "@/assets/img/others/h5_footer_bg_shape.svg"
import bg_img from "@/assets/img/bg/h5_footer.jpg"

const FooterThree = () => {
   return (
      <footer className="footer__area-four footer__bg" style={{ backgroundImage: `url(${bg_img.src})` }}>
