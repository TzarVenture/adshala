...
import bg_img from "@/assets/img/bg/h8_about_bg.jpg"

const About = () => {
   return (
      <section className="about-area-six about__bg" style={{ backgroundImage: `url(${bg_img.src})` }}>
         ...
         <div className="about__shape-wrap">
            <Image src={about_img4} alt="shape" />
            <Image src={about_img5} alt="shape" />
         </div>
      </section>
   )
}
