...
import shape_1 from "@/assets/img/banner/h8_hero_title_shape.svg"
import shape_2 from "@/assets/img/banner/h8_hero_img_shape02.svg"
import bg_img from "@/assets/img/banner/h8_hero_bg.jpg"
...
const Banner = () => {
    ...
    return (
        <section className="banner-area fix banner-bg-seven tg-motion-effects" style={{ backgroundImage: `url(${bg_img.src})` }}>
            <div className="container">
                <div className="row align-items-center justify-content-center">
                    <div className="col-lg-6">
                        <div className="banner__content-seven">
                            <h2 className="title">Take Your
                                <span className="title-shape-wrap">Cooking <InjectableSvg src={shape_1.src} alt="" className="injectable" /></span>
                    ...
                    <div className="col-lg-6 col-md-10">
                        <div className="banner__images-seven">
                            ...
                            <div className="big_shape">
                                <InjectableSvg src={shape_2.src} alt="" className="injectable tg-motion-effects1" />
                            </div>
                            <div className="shape" >
                            ...
                            <div className="banner__all-recipe" >
