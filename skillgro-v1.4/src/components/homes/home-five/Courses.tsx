...
import shape_1 from "@/assets/img/courses/h5_courses_bg_shape01.svg"
import shape_2 from "@/assets/img/courses/h5_courses_bg_shape02.svg"
import icon_1 from "@/assets/img/icons/heart02.svg";
import bg_img from "@/assets/img/bg/h5_courses_bg.jpg"
...
const Courses = () => {
   ...
   return (
      <section className="courses-area-four courses__bg-three" style={{ backgroundImage: `url(${bg_img.src})` }}>
         ...
         <div className="courses__bg-shape-two">
            <InjectableSvg src={shape_2.src} alt="" className="injectable" />
         </div>
                  ...
                  <div key={item.id} className="col-xl-3 col-lg-4 col-md-6">
                     <div className="courses__item-six shine__animate-item">
                        <div className="courses__item-thumb-five shine__animate-link">
                           ...
                           <a onClick={() => handleAddToWishlist(item)} className="courses__wishlist-two course-heart-btn" style={{ cursor: "pointer" }}><InjectableSvg src={icon_1.src} alt="" className="injectable" /></a>
                        </div>
         ...
         <div className="courses__shape-wrap-three">
            <Image src={course_img1} alt="shape" />
            <Image src={course_img2} alt="shape" />
            <Image src={course_img3} alt="shape" className="alltuchtopdown" />
            <Image src={course_img4} alt="shape" />
         </div>
      </section>
   )
}
