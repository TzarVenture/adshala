...
import shape_1 from "@/assets/img/others/h5_testimonial_bg_shape01.svg"
import shape_2 from "@/assets/img/others/h5_testimonial_bg_shape02.svg"
   ...
   return (
      <section className="testimonial__area-four tg-motion-effects">
         ...
         <div className="testimonial__shape-wrap">
            <Image src={testi_img5} alt="shape" />
            <Image src={testi_img6} alt="shape" />
         </div>
      </section>
   )
}
