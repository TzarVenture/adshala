...
import bg_img from "@/assets/img/banner/h3_hero_bg.jpg"

const Banner = () => {
   return (
      <section className="banner-area banner-bg-three tg-motion-effects" style={{ backgroundImage: `url(${bg_img.src})` }}>
         <div className="container">
            <div className="row justify-content-between align-items-start">
               <div className="col-xl-5 col-lg-6">
                  <div className="banner__content-three">
                     <span className="sub-title" >FOR A BETTER FUTURE</span>
                     <h2 className="title">Empowering Minds Inspiring <span>Futures</span></h2>
                     <p>Every teaching and learning journey is unique Follwoing We&apos;ll help guide your way.</p>
                     <div className="banner__btn-wrap">
                        <Link href="/courses" className="btn arrow-btn">Find Your Course <BtnArrow /></Link>
                     </div>
                     <div className="shape">
                        <Image src={banner_img1} alt="shape" />
                     </div>
                  </div>
               </div>
