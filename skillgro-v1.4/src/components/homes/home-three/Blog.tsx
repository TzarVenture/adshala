...
import bg_img from "@/assets/img/bg/h3_blog_bg.jpg"

const Blog = () => {
   return (
      <section className="blog__post-area-three tg-motion-effects blog__bg" style={{ backgroundImage: `url(${bg_img.src})` }}>
