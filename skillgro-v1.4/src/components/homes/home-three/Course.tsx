...
import bg_img from "@/assets/img/bg/h3_courses_bg.jpg"
...
const Course = () => {
   ...
   return (
      <section className="courses-area-two tg-motion-effects courses__bg" style={{ backgroundImage: `url(${bg_img.src})` }}>
                        ...
                        <div className="courses__item-content-three">
                           <ul className="courses__item-meta list-wrap">
                              ...
                              <li className="courses__wishlist">
                                 <a onClick={() => handleAddToWishlist(item)} className="course-heart-btn" style={{ cursor: "pointer" }}><InjectableSvg src={icon_1.src} alt="" className="injectable" /></a>
                              </li>
                           </ul>
