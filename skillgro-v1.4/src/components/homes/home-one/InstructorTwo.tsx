...
import shape_1 from "@/assets/img/instructor/instructor_shape01.svg"
import shape_2 from "@/assets/img/instructor/instructor_shape02.svg"
...
const InstructorTwo = ({ style }: StyleType) => {
   ...
   const svgIconRef = useSvgAnimation('/svg-animation-img/fact_shape02.svg');
   const svgIconRef2 = useSvgAnimation('/svg-animation-img/fact_shape02.svg');
                     ...
                     <div className="instructor__item-two tg-svg" ref={svgIconRef}>
                        <div className="instructor__thumb-two">
                           ...
                           <div className="shape-one">
                              <InjectableSvg src={shape_1.src} alt="img" className="injectable" />
                           </div>
