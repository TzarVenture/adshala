                     ...
                     <div className="about__content">
                        ...
                        <ul className="about__info-list list-wrap">
                           <li className="about__info-list-item">
                              ...
                              <p className="content">100% Placement Assistance</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Industry-Relevant Curriculum</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                           ...
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Hands-On Projects</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Expert Mentors</p>
                           </li>
                        </ul>
