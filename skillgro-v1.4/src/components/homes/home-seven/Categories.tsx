...
import bg_img from "@/assets/img/bg/categories_bg.jpg"
...
const Categories = () => {
   return (
      <section className="categories-area-three fix section-pt-140 section-pb-110 categories__bg" style={{ backgroundImage: `url(${bg_img.src})` }}>
         ...
         <div className="categories__shape-wrap">
            ...
            <Image src={category_img2} alt="shape" />
            <Image src={category_img3} alt="shape" className="alltuchtopdown" />
            <Image src={category_img4} alt="shape" />
         </div>
      </section>
   )
}
