...
import icon_2 from "@/assets/img/icons/graph.svg";
import bg_img from "@/assets/img/bg/h6_courses_bg.jpg"

const Courses = () => {
  return (
    <section className="courses-area-five section-py-140 courses__bg-four" style={{ backgroundImage: `url(${bg_img.src})` }}>
            ...
            <div key={item.id} className="col-xl-3 col-lg-4 col-md-6">
              <div className="courses__item-seven">
                <div className="courses__item-thumb-six">
                  ...
                  <Link href="/course-details" className="courses__wishlist-two"><InjectableSvg src={icon_1.src} alt="" className="injectable" /></Link>
                ...
                <div className="courses__item-content-six">
                  ...
                  <ul className="courses__item-meta-two list-wrap">
                    <li>{item.country} <InjectableSvg src={icon_2.src} alt="" className="injectable" /></li>
                    <li>{item.language} <InjectableSvg src={icon_2.src} alt="" className="injectable" /></li>
                  </ul>
                  <p>{item.desc}</p>
                </div>
