...
import shape from "@/assets/img/instructor/h2_instructor_img_shape01.svg";
import bg_img from "@/assets/img/bg/instructor_bg.jpg";
...
const Instructor = () => {
   ...
   const [, setIsLoop] = useState(false);
   useEffect(() => {
      setIsLoop(true);
   }, []);
   ...
   return (
      <section className="instructor__area-three instructor__bg" style={{backgroundImage:`url(${bg_img.src})` }}>
                           ...
                           <div className="instructor__item-three">
                              <div className="instructor__thumb-three">
                                 ...
                                 <div className="shape-one">
                                    <InjectableSvg src={shape.src} alt="img" className="injectable" />
                                 </div>
                              </div>
