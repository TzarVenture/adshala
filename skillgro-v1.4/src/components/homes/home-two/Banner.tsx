...
import shape_1 from "@/assets/img/banner/h2_banner_shape01.svg"
import shape_2 from "@/assets/img/banner/h2_banner_icon.svg"
import bg_img from "@/assets/img/banner/banner_bg02.png"

const Banner = () => {

   const svgIconRef = useSvgAnimation('/svg-animation-img/h2_banner_shape02.svg');
   const [isVideoOpen, setIsVideoOpen] = useState(false);

   return (
      <>
         <section className="banner-area-two banner-bg-two tg-motion-effects" style={{ backgroundImage: `url(${bg_img.src})` }}>
                  ...
                  <div className="col-xl-7 col-lg-6 col-md-8">
                     <div className="banner__images-two tg-svg" ref={svgIconRef}>
                        ...
                        <div className="shape big-shape">
                           <InjectableSvg src={shape_1.src} alt="shape" className="injectable tg-motion-effects1" />
                        </div>
                        ...
                        <div className="banner__student" >
                           <div className="icon">
                              <InjectableSvg src={shape_2.src} alt="img" className="injectable" />
                           </div>
            ...
            <Image src={bannerImg_6} alt="shape" className="line-shape-two" />
         </section>
         <VideoPopup
            isOpen={isVideoOpen}
