...
import shape from "@/assets/img/others/faq_shape01.png"

const About = () => {
   const svgIconRef = useSvgAnimation('/svg-animation-img/title_shape.svg');
                  ...
                  <div className="faq__img-wrap tg-svg" ref={svgIconRef}>
                     ...
                     <div className="faq__img faq__img-two">
                        ...
                        <div className="shape-one">
                           <InjectableSvg src={shape.src} className="injectable tg-motion-effects4" alt="img" />
                        </div>
