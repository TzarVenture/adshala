...
import bg_img from "@/assets/img/bg/h4_courses_bg.jpg"
...
const Course = () => {
   ...
   return (
      <section className="courses-area-three section-pt-140 section-pb-110 courses__bg-two" style={{ backgroundImage: `url(${bg_img.src})` }}>
