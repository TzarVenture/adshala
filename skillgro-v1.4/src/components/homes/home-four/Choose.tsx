...
import icon_1 from "@/assets/img/icons/circle_icon.svg"
import icon_2 from "@/assets/img/icons/choose_icon.svg"
import bg_img from "@/assets/img/bg/h4_choose_bg.jpg"

const Choose = () => {
   return (
      <section className="choose__area-two section-py-140 choose__bg" style={{ backgroundImage: `url(${bg_img.src})` }}>
               ...
               <div className="col-lg-6">
                  <div className="choose__content-two">
                     <div className="section__title mb-20">
                        ...
                        <h2 className="title-two"><span>Trained</span> Your <strong><InjectableSvg src={icon_2.src} alt="" className="injectable" /></strong> Body Mind <span>Through Our</span> Yoga</h2>
                     </div>
