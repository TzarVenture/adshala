...
import bg_img from "@/assets/img/bg/features_bg.jpg"

const Features = () => {
   return (
      <section className="features__area-five features__bg section-pt-120 section-pb-90" style={{ backgroundImage: `url(${bg_img.src})` }}>
                        ...
                        <div key={item.id} className="col-lg-4 col-md-6">
                           <div className="features__item-four">
                              <div className="features__icon-four">
                                 {item.icon && (<InjectableSvg src={item.icon.src} alt="img" className="injectable" />)}
                              </div>
         ...
         <div className="features__shape-wrap">
            <Image src={feature_shape1} alt="shape" />
            <Image src={feature_shape2} alt="shape" />
         </div>
      </section>
   )
}
