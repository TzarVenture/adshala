...
const faq_data: DataType[] = [
  {
    ...
    faq_details: [
      ...
      },
      {
        lock: true,
        title:
          "Top Marketplaces in India (Amazon, Flipkart, Meesho, Myntra, Ajio)",
        duration: "07:48",
      },
      {
        lock: true,
  ...
  },
  {
    ...
    faq_details: [
      ...
      },
      {
        lock: true,
        title:
          "Image Editing for Marketplace (Background Removal, Enhancement)",
        duration: "10:48",
      },
      {
        lock: true,
  ...
  return (
    <>
      <div className="courses__curriculum-wrap">
        ...
        <p>
          Learn to sell successfully on Amazon, Flipkart and other marketplaces
          through product listing, catalog management, pricing, advertising,
          inventory control, order management and sales optimization strategies.
        </p>
