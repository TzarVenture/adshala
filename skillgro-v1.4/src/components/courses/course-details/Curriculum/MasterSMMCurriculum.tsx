  ...
  return (
    <>
      <div className="courses__curriculum-wrap">
        ...
        <p>
          Learn platform strategies, content planning, reels, paid advertising,
          influencer marketing, analytics, community management and growth
          techniques to create impactful social media campaigns for brands and
          businesses.
        </p>
